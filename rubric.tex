...
{\teacherName nemá ve výuce jasně stanovené cíle. Když učí, nevnímá, co se děje a kam směřujeme. Často působí ztraceně.}
{\teacherName si někdy uvědomuje, jaký má cíl, co právě dělá a jaký to bude mít efekt. Většinou ale při výuce nemá vědomou pozornost.}
{Během výuky si \teacherName téměř vždy uvědomuje, jaký cíl sleduje, co se skupinou děje, co dělá a jaký to bude mít efekt. Ví, jak jsme se dostali tam, kde právě jsme.}
...
{\teacherName se skupinou neinteraguje. Neptá se a neví, jak studenty zapojit.}
{\teacherName ví, že lze interagovat se skupinou a zná nástroje (chápe, jak by to šlo). Nedokáže je ale dobře používat. Někdy se skupiny ptá, ale nedostává odpověď.}
...
{O strukturování výuky \teacherName vůbec nepřemýšlí.}
{\teacherName chápe smysl přehledného strukturování své hodiny a snaží se o to. Často se ale zamotá, ztratí nit, nebo řeší více věcí naráz a studenti se pak ztrácí nebo odpojují.}
...
{\teacherName působí nespokojeně se svými hodinami. Netěší se do výuky.}
{\teacherName si ve výuce často moc nevěří. Někdy mu/jí vyjdou části hodiny, ale často působí napjatě nebo má strach, že něco pokazí.}
...
{\teacherName nijak zvlášť nepřemýšlí o tom, jak zadávat pokyny nebo úlohy.}
...
{\teacherName učí tak, jak mu/ji řekli nebo kopíruje výuku, kterou zažil(a). Nepřemýšlí o jiných variantách.}
{\teacherName si uvědomuje, že existuje mnoho typů aktivit, které lze při výuce použít. Nezná jich ale dostatek, nedokáže je efektivně zadávat, nebo nemá jasno v tom, proč je používat.}
...
{O širším kontextu výuky a kurzu \teacherName nepřemýšlí.}
{\teacherName neví, v jakém kontextu studenti využijí znalosti a dovednosti, které učí. Nevidí propojení s dalšími kurzy.}
{\teacherName má jasnou představu o tom, k čemu studenty vede (jaké dovednosti rozvíjí, jaké znalosti chce předat). Ví, proč tyto dovednosti rozvíjí a v jakém kontextu je studenti v budoucnu použijí. Vidí širší kontext.}

\rule{\columnwidth}{0.4pt}

\rubriccriterion{Jasné vysvětlování}
{\teacherName svoje způsoby vysvětlování nijak nereflektuje.}
{Když \teacherName vysvětluje, běžně se stává, že si není jistý, zda vysvětluje dobře a zda to studentům pomáhá při pochopení.}
{Když \teacherName vysvětluje teorii, demonstruje řešení a efektivně opravuje chyby. Dokáže se dobře vžít do toho, jak to vidí student a efektivně pomáhá studentům pochopit problém. Nestává se, že by vysvětloval(a) něco, na co se studenti neptali.}

\rule{\columnwidth}{0.4pt}

\rubriccriterion{Nastavení prostředí, systémy ve výuce}
{\teacherName o atmosféře ve výuce nepřemýšlí.}
{\teacherName přemýšlí o nastavení pravidel i atmosféry. Nemá ale jasno v efektech těchto pravidel.}
{\teacherName umí ve výuce vytvořit prostředí, které podporuje efektivní učení. U systémů, které používá (např. bodování, bonbóny, zahajovací rituály) chápe efekt a uzpůsobuje je podle svých potřeb.}

\columnbreak

\rubriccriterion{Flexibilita, přizpůsobování výuky na místě}
{Na situace vzniklé v průběhu výuky \teacherName nijak vědomě nereaguje.}
{\teacherName si uvědomuje chvíle, kdy by mohlo být zajímavé nebo užitečné dělat něco jiného, než měl(a) v plánu. Většinou ale nedokáže v daný moment vhodně zareagovat.}
...
{\teacherName si uvědomuje možnosti práce ve dvojicích či menších skupinách. Tuší, že bych toho mohl(a) lépe využívat, hledá jak.}
{\teacherName má jasno v tom, kdy chce pracovat s celou skupinou, kdy s jednotlivci a kdy se skupinkami. Rozdělení do menších skupin efektivně používá, když je to potřeba. Ve vhodných případech zadává interakce mezi skupinami.}

\rule{\columnwidth}{0.4pt}

\rubriccriterion{Čtení atmosféry ve skupině}
{Skupinu ve své výuce \teacherName nesleduje, pozornost věnuje pouze obsahu.}
{\teacherName si uvědomuje, že mu/ji skupina vysílá signály a že by bylo dobré jim rozumět a využít je pro efektivní vedení výuky. Ve výuce to ale dokáže jen výjimečně.}
{\teacherName dokáže dobře odhadnout naladění skupiny. Má jasno v tom, co se ve skupině studentů děje (např. únava, nadšení, obava).}
